...
if (!exists("Illinois_Data_LONG")) {
  ...
  Illinois_Data_LONG <-
    freadZIP(
      "Data/Cleaned_Data/Student_LongTestData_Illinois_2016-2019_AVI.csv.zip"
    )
}
...
rm(Illinois_Data_LONG)
Illinois_Data_LONG <- copy(Illinois_SGP@Data)

setnames(x = Illinois_Data_LONG, old = "SGP", new = "SGP_Cnd_0")
Illinois_Data_LONG[,
...
Condition_0_CoefMatrices <- copy(Illinois_SGP@SGP[["Coefficient_Matrices"]])
...
setnames(x = Illinois_Data_LONG, old = "SGP", new = "SGP_Cnd_1b")
Illinois_Data_LONG[,
    c("SGP_NORM_GROUP", "SGP_NORM_GROUP_SCALE_SCORES",
      "SCALE_SCORE_PRIOR", "SCALE_SCORE_PRIOR_STANDARDIZED"
    ) := NULL
...
Condition_1b_CoefMatrices <- copy(Illinois_SGP@SGP[["Coefficient_Matrices"]])
...
#' conditions 1b and 2. The data object `Illinois_Data_LONG` now includes the
...
setnames(x = Illinois_Data_LONG, old = "SGP", new = "SGP_Cnd_1c")
Illinois_Data_LONG[,
    c("SGP_NORM_GROUP", "SGP_NORM_GROUP_SCALE_SCORES",
      "SCALE_SCORE_PRIOR", "SCALE_SCORE_PRIOR_STANDARDIZED"
    ) := NULL
...
Condition_1c_CoefMatrices <- copy(Illinois_SGP@SGP[["Coefficient_Matrices"]])
...
#'
#' The call to the`abcSGP` function here is identical to that made for
#' conditions 1b and 1c. The data object `Illinois_Data_LONG` now includes the
...
setnames(x = Illinois_Data_LONG, old = "SGP", new = "SGP_Cnd_2")
Illinois_Data_LONG[,
    c("SGP_NORM_GROUP", "SGP_NORM_GROUP_SCALE_SCORES",
...
Condition_2_CoefMatrices <- copy(Illinois_SGP@SGP[["Coefficient_Matrices"]])
...
save("Illinois_Data_LONG", file = "Data/Student_Growth/Illinois_Data_LONG.rda")

fname <- "Data/Student_Growth/Student_LongTestData_Illinois_2016-2019_AVI.csv"
