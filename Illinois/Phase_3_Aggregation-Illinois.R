...
if (!exists("Illinois_Data_LONG")) {
  ...
  Illinois_Data_LONG <-
    freadZIP(
      "Data/Student_Growth/Student_LongTestData_Illinois_2016-2019_AVI.csv.zip"
    )
}
...
fwrite(sch_summary_cnd_0[YEAR == 2018][, YEAR := NULL],
    file = "Data/School_Summaries/School_Condition_0_Illinois_2018_AVI.csv"
)
fwrite(sch_summary_cnd_0[YEAR == 2019][, YEAR := NULL],
    file = "Data/School_Summaries/School_Condition_0_Illinois_2019_AVI.csv"
)
...
fwrite(school_aggregation_all_students,
    file = "Data/School_Summaries/School_Condition_AllGrowth_AllStudents_Illinois_AllYears_AVI.csv"
)
...
fwrite(sch_summary_cnd_1a[YEAR == 2018][, YEAR := NULL],
    file = "Data/School_Summaries/School_Condition_1a_Illinois_2018_AVI.csv"
)
fwrite(sch_summary_cnd_1a[YEAR == 2019][, YEAR := NULL],
    file = "Data/School_Summaries/School_Condition_1a_Illinois_2019_AVI.csv"
)
...
fwrite(school_aggregation_student_demogs,
    file = "Data/School_Summaries/School_Condition_AllGrowth_Demographics_Illinois_AllYears_AVI.csv"
)
